...
- [ ] **W2-7. CAPI/TikTok внутри row-lock транзакции (AN-011 / DB-009, P1)** `[REPO]`
...
- [ ] **W2-10. Прочее аналитическое (P1/P2, после ядра)** `[REPO]`
  - [ ] **AN-014/TECH-074:** delivered-Purchase уходит только в Meta → добавить TikTok/GA4 в NP-delivery-путь; refund/cancel-события для невыкупов.
  ...
  - [ ] **AN-051/NEW-404 (P1-retention):** UTMSession+UserAction не чистятся никогда → retention-cron; политика приватности не упоминает IP/гео → обновить текст (NEW-403).
