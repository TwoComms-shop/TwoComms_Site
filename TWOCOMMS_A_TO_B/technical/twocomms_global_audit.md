...
- [ ] **AEO-001. AI-трафик уже идёт — усилить.** Где: БД: 109 сессий utm_source=chatgpt.com. Что: понять, какие стран��цы цитирует ChatGPT (landing_page этих UTM-сессий — запрос к БД); усилить эти с��раницы фактологией (состав, замеры, сроки, цены).
...
- [ ] **CB-034. analytics-loader.js 56KB.** Где: static/js/analytics-loader.js. Что: аудит содержимого: какие пиксели/логика внутри, ��сть ли мёртвые ветки (Celery-эпоха, старые эксперименты ab_testing); дублирует ли GTM-теги (двойной счёт событий — связка с AN-001).
