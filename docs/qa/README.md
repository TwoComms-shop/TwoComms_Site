...
| Dirty utm_source live | F-084 **FIXED `069f4efa`**; F-020/F-057 remain open for non-AI history | PLAN_VS **W2-8** nuance | shared middleware/first-touch/rebuild normalizer + guarded `normalize_ai_attribution`; broader alias policy still separate |
