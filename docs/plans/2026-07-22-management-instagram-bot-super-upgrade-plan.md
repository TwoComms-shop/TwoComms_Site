...
- [ ] **P0.B5 Separate observation/analysis from global and per-client reply enablement.**
  ...
  - [x] **P0.B5ah Version changed deterministic classification semantics.**
    ...
    - **Implementation/evidence:** scoring and communication semantics now use `ANALYSIS_RULES_VERSION=2026-07-24.v3`; production MariaDB temporary-table proof asserted the new snapshot version and dedupe behavior on SHA `c564a9e0`, with historical rows left append-only.
