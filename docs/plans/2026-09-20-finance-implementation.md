...
- [ ] `USER` Отдельно подготовить review-очередь для 4 найденных terminal-пополнений (16.09: 9 800; 23.08: 14 000; 14.07: 19 820; 20.06: 18 430 грн). Не применять исторические изменения без явного подтверждения.
