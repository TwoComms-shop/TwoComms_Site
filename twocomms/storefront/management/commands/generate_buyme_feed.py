...
from storefront.services.marketplace_feeds import build_buyme_feed_xml, build_profile_offers, iter_feed_offers, resolve_base_url
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        output_path.write_bytes(build_buyme_feed_xml(base_url=base_url, feed=feed))
