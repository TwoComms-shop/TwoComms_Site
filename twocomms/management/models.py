...
DEFAULT_BOT_SYSTEM_PROMPT = (
    ...
    "• [STAGE:x] — поточний етап діалогу. x лише із: new, qualifying, "
    "product_matched, checkout, payment_pending, lead_manager, cold. Ніколи не став "
    "paid/order_created/done: оплату й виконання підтверджує тільки система.\n"
