...
DEFAULT_BOT_SYSTEM_PROMPT = CANONICAL_IG_CORE_POLICY
...
from .ig_journey_models import (IgConversationRouteDecision, IgJourneyTraceSnapshot,
    IgJourneyTraceRefreshControl, IgJourneyTraceRefreshJob)  # noqa: E402,F401
