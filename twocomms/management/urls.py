...
urlpatterns = [
    ...
    path('data-deletion/submit/', bot_views.data_deletion_submit, name='management_data_deletion_submit'),
    path('data-deletion/request/', bot_views.data_deletion_callback, name='management_data_deletion_callback'),
    path('data-deletion/status/<str:confirmation_code>/', bot_views.data_deletion_status, name='management_data_deletion_status'),
    ...
    path('bot/data-deletion/request/', bot_views.data_deletion_callback, name='management_bot_data_deletion_callback'),
    path('bot/app-review/', bot_views.app_review_info, name='management_bot_app_review_info'),
    ...
    path('bot/api/gemini-health/', bot_views.bot_gemini_health_api, name='management_bot_gemini_health_api'),
    path('bot/api/gemini-health/probe/', bot_views.bot_gemini_health_probe_api, name='management_bot_gemini_health_probe_api'),
    path('bot/api/gemini-v2/quotas/', bot_views.bot_gemini_v2_quotas_api, name='management_bot_gemini_v2_quotas_api'),
    path('bot/api/gemini-v2/routes/', bot_views.bot_gemini_v2_routes_api, name='management_bot_gemini_v2_routes_api'),
    path('bot/api/gemini-v2/attempts/', bot_views.bot_gemini_v2_attempts_api, name='management_bot_gemini_v2_attempts_api'),
    path('bot/api/inbox-refresh/start/', bot_views.bot_inbox_refresh_start_api, name='management_bot_inbox_refresh_start_api'),
    path('bot/api/inbox-refresh/status/', bot_views.bot_inbox_refresh_status_api, name='management_bot_inbox_refresh_status_api'),
    path('bot/api/inbox-refresh/<int:run_id>/cancel/', bot_views.bot_inbox_refresh_cancel_api, name='management_bot_inbox_refresh_cancel_api'),
    path('bot/api/inbox-refresh/<int:run_id>/retry/', bot_views.bot_inbox_refresh_retry_api, name='management_bot_inbox_refresh_retry_api'),
    path('bot/api/notifications/review/', bot_views.bot_notification_review_api, name='management_bot_notification_review_api'),
    path('bot/api/notifications/<int:notification_id>/review/', bot_views.bot_notification_review_action_api, name='management_bot_notification_review_action_api'),
    ...
    path('bot/api/checkout-proposals/', bot_views.bot_checkout_proposals_api, name='management_bot_checkout_proposals_api'),
    path('bot/api/checkout-proposals/<uuid:proposal_id>/', bot_views.bot_checkout_proposal_preview_api, name='management_bot_checkout_proposal_preview_api'),
    ...
    path('bot/api/clients/<int:client_id>/ugc-assessments/<int:assessment_id>/review/', bot_views.bot_client_ugc_assessment_review_api, name='management_bot_client_ugc_assessment_review_api'),
    ...
    path('bot/api/policy/preview/', bot_views.bot_policy_preview_api, name='management_bot_policy_preview_api'),
    path('bot/api/policy/publish/', bot_views.bot_policy_publish_api, name='management_bot_policy_publish_api'),
    path('bot/api/policy/history/', bot_views.bot_policy_history_api, name='management_bot_policy_history_api'),
    path('bot/api/policy/rollback/', bot_views.bot_policy_rollback_api, name='management_bot_policy_rollback_api'),
